...
describe('Fragment class', () => {
    ...
    describe('Fragment()', () => {
        ...
        test('fragments use created and updated timestamps passed in if present', () => {
            const fragment = new Fragment({
                ownerId: '1234',
                type: 'text/plain',
                created: new Date('2022-01-01').toISOString(),
                updated: new Date('2022-01-01').toISOString(),
            });
            expect(fragment.created).toEqual(new Date('2022-01-01').toISOString());
            expect(fragment.updated).toEqual(new Date('2022-01-01').toISOString());
        });
    ...
    describe('save(), getData(), setData(), byId(), byUser(), delete()', () => {
        ...
        test('a fragment can be created and save() stores a fragment for the user', async () => {
            ...
            expect(await Fragment.prototype.getData.call(fragment2)).toEqual(data);
        });
